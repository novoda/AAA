...
module.exports = df.orchestrator(function* (context) {
    ...
    outputs.push(yield context.df.callActivity("Hello", {"orderStatus": "waiting", "regId" : regId}));
    const approved = yield context.df.waitForExternalEvent("Approval");
    outputs.push(yield context.df.callActivity("Hello", {"orderStatus": "last", "regId" : regId}));
    return outputs;
});